...
export default function LibraryPage() {
  const { isAuthenticated, isLoading, getAccessTokenRaw } = useKindeBrowserClient();
  ...
  useEffect(() => {
    ...
    load();
  }, [isAuthenticated, isLoading, getAccessTokenRaw]);
  ...
  if (!isAuthenticated) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-20 text-center">
        ...
        <p className="mt-3 text-gray-500">Sign in to view your purchased bundles.</p>
        <LoginLink className="mt-6 inline-flex rounded-lg bg-brand-600 px-6 py-3 text-white hover:bg-brand-700 transition-colors">
          Sign in
        </LoginLink>
      </div>
    );
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      {loading ? (
        ...
        <div className="mt-8 rounded-xl border border-dashed border-gray-300 py-16 text-center">
          <p className="text-gray-400">You haven&apos;t purchased any bundles yet.</p>
          <Link
            href="/"
